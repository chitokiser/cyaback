...
contract cut1 is IERC20 {  // 1호 유틸리티
    string public constant name = "CyaUtilityToken1st";
    string public constant symbol = "CUT1";
   ...
   constructor(string memory _metainfo) {
    ...
    function mint( )public{   //발행 토큰 수 고정 초기 배분율 조절 가능
